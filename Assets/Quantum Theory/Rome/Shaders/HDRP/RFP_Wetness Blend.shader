...
Shader "Quantum Theory/RFP/HDRP/PBR - Wetness Blend"
{
	Properties
	{
		...
		_BumpMapB("Normal Map 2", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_MainTexB = packedInput.ase_texcoord5.xy * _MainTexB_ST.xy + _MainTexB_ST.zw;
				float2 uv_MainTex = packedInput.ase_texcoord5.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 lerpResult8 = lerp( tex2D( _MainTexB, uv_MainTexB ) , tex2D( _MainTex, uv_MainTex ) , packedInput.ase_color.g);
				float4 temp_cast_0 = (( ( ( 1.0 - _Power ) * packedInput.ase_color.r ) + _Power )).xxxx;
				
				float2 uv_BumpMapB = packedInput.ase_texcoord5.xy * _BumpMapB_ST.xy + _BumpMapB_ST.zw;
				float2 uv_BumpMap = packedInput.ase_texcoord5.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float4 lerpResult22 = lerp( tex2D( _BumpMapB, uv_BumpMapB ) , tex2D( _BumpMap, uv_BumpMap ) , packedInput.ase_color.g);
				
				float2 uv_MetallicGlossMapB = packedInput.ase_texcoord5.xy * _MetallicGlossMapB_ST.xy + _MetallicGlossMapB_ST.zw;
				float2 uv_MetallicGlossMap = packedInput.ase_texcoord5.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float4 lerpResult14 = lerp( tex2D( _MetallicGlossMapB, uv_MetallicGlossMapB ) , tex2D( _MetallicGlossMap, uv_MetallicGlossMap ) , packedInput.ase_color.g);
				float4 break15 = lerpResult14;
				
				surfaceDescription.Albedo = pow( lerpResult8 , temp_cast_0 ).rgb;
				surfaceDescription.Normal = lerpResult22.rgb;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = break15.r;
				...
				surfaceDescription.Smoothness = ( break15.a + ( _SmoothnessModulation * ( 1.0 - packedInput.ase_color.a ) ) );
				surfaceDescription.Occlusion = break15.g;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_MainTexB = packedInput.ase_texcoord.xy * _MainTexB_ST.xy + _MainTexB_ST.zw;
				float2 uv_MainTex = packedInput.ase_texcoord.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 lerpResult8 = lerp( tex2D( _MainTexB, uv_MainTexB ) , tex2D( _MainTex, uv_MainTex ) , packedInput.ase_color.g);
				float4 temp_cast_0 = (( ( ( 1.0 - _Power ) * packedInput.ase_color.r ) + _Power )).xxxx;
				
				float2 uv_BumpMapB = packedInput.ase_texcoord.xy * _BumpMapB_ST.xy + _BumpMapB_ST.zw;
				float2 uv_BumpMap = packedInput.ase_texcoord.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float4 lerpResult22 = lerp( tex2D( _BumpMapB, uv_BumpMapB ) , tex2D( _BumpMap, uv_BumpMap ) , packedInput.ase_color.g);
				
				float2 uv_MetallicGlossMapB = packedInput.ase_texcoord.xy * _MetallicGlossMapB_ST.xy + _MetallicGlossMapB_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_BumpMapB = packedInput.ase_texcoord3.xy * _BumpMapB_ST.xy + _BumpMapB_ST.zw;
				float2 uv_BumpMap = packedInput.ase_texcoord3.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float4 lerpResult22 = lerp( tex2D( _BumpMapB, uv_BumpMapB ) , tex2D( _BumpMap, uv_BumpMap ) , packedInput.ase_color.g);
				
				float2 uv_MetallicGlossMapB = packedInput.ase_texcoord3.xy * _MetallicGlossMapB_ST.xy + _MetallicGlossMapB_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_MainTexB = packedInput.ase_texcoord7.xy * _MainTexB_ST.xy + _MainTexB_ST.zw;
				float2 uv_MainTex = packedInput.ase_texcoord7.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 lerpResult8 = lerp( tex2D( _MainTexB, uv_MainTexB ) , tex2D( _MainTex, uv_MainTex ) , packedInput.ase_color.g);
				float4 temp_cast_0 = (( ( ( 1.0 - _Power ) * packedInput.ase_color.r ) + _Power )).xxxx;
				
				float2 uv_BumpMapB = packedInput.ase_texcoord7.xy * _BumpMapB_ST.xy + _BumpMapB_ST.zw;
				float2 uv_BumpMap = packedInput.ase_texcoord7.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float4 lerpResult22 = lerp( tex2D( _BumpMapB, uv_BumpMapB ) , tex2D( _BumpMap, uv_BumpMap ) , packedInput.ase_color.g);
				
				float2 uv_MetallicGlossMapB = packedInput.ase_texcoord7.xy * _MetallicGlossMapB_ST.xy + _MetallicGlossMapB_ST.zw;
...
/*ASEBEGIN
Version=18000
1920;0;1920;1139;2145.827;540.9425;1.646639;True;False
...
Node;AmplifyShaderEditor.VertexColorNode;7;-1022.34,235.2562;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;8;-587.4683,16.85153;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.PowerNode;10;-307.3304,272.8588;Inherit;False;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;22;-765.9431,922.8981;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
WireConnection;31;4;15;0
WireConnection;31;7;16;0
WireConnection;31;8;15;1
ASEEND*/
//CHKSM=5E05D9CA01C0E4EC2A614EA6B6883E9987FF5799